...
| automation, matrix, что автоматизировать | [automation-matrix.md](references/automation-matrix.md) |
| output, patterns, форматы вывода | [output-patterns.md](references/output-patterns.md) |
| quality multipliers, множители качества | [quality-multipliers.md](references/quality-multipliers.md) |
| team analysis, анализ команды | [team-analysis.md](references/team-analysis.md) |
| workflows, процессы | [workflows.md](references/workflows.md) |
| template, structure, format | [agent-template.md](assets/agent-template.md) |
| team template, командный скилл | [skill-template-team.md](assets/skill-template-team.md) |
